...
* Interactivity
    - Common interactions for all plot types: brushing, selection, linking, zooming, panning, and querying
    - Some special interactions for temporal data: wrapping, faceting, mirroring, shifting, and switching
* Linking 
    - Self-linking
